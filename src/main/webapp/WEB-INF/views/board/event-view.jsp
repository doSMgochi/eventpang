...
<div class="event-container">
    ...
    <c:if test="${loggedInUser != null && loggedInUser.user_id == event.evt_userid}">
        <div class="event-actions">
            <a href="${rootPath}/board/event-modify/${event.evt_num}" class="btn btn-primary">수정</a>
            <form action="${rootPath}/board/event-delete/${event.evt_num}" method="post" style="display:inline;">
